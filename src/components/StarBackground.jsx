...
// id, x, y, size, speed, opacity, animationDuration
// id, x, y, size, speed, delay, animationDuration
...
export const StarBackground = () => {
    ...
    const generateStars = () => {
        const numberOfStars = Math.floor((window.innerWidth * window.innerHeight) / 10000); // Adjust density
    ...
    const generateMeteors = () => {
        const numberOfMeteors = 4; // Adjust density
        const newMeteors =[];
