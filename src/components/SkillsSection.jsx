...
//   { name: "Figma", level: 85, category: "tools" },
    { name: "VS Code", level: 35, category: "tools" },
    // { name: "Postman", level: 40, category: "tools" },
//   { name: "Webpack", level: 50, category: "tools" },
    
  // Design
    { name: "UI/UX Design", level: 35, category: "design" },
    { name: "Responsive Design", level: 50, category: "design" },
    { name: "GSAP", level: 25, category: "design" },
...
const categories = ["all", "frontend", "backend", "tools", "design", "soft"]
export const SkillsSection = () => {
    const [activeCategory, setActiveCategory] = useState("all")

    const filteredSkills = skills.filter((skill) => activeCategory === "all" || skill.category === activeCategory);
    const skillsToShow = filteredSkills.length > 0 ? filteredSkills : skills;
